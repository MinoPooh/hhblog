...
<body>
	...
	<div id="wrap" align="center">
		<div id="wrap">
			<form id="frm" name="frm" enctype="multipart/form-data">
				...
				<input type="hidden" name="BOARD_CODE" id="BOARD_CODE" value="1"
					readonly="readonly" /> <input type="hidden" name="CREA_ID"
					id="CREA_ID" value="${sessionScope.userId}" readonly="readonly" />
				<input type="hidden" name="BOARD_NAME" id="BOARD_NAME"
					value="/sample/freeboardWrite" readonly="readonly" />
			</form>

			<a href="#this" class="btn" id="addFile">파일 추가</a> <a href="#this"
				class="btn" id="list">목록으로</a> <a href="#this" class="btn"
				id="update">저장하기</a> <a href="#this" class="btn" id="delete">삭제하기</a>
		</div>
		...
		<script type="text/javascript">
			...
			function fn_openCodeBoardList() {
				var comSubmit = new ComSubmit();
				comSubmit
						.setUrl("<c:url value='/sample/openCodeBoardList.do' />");
				comSubmit.addParam("BOARD_CODE", 1);
				comSubmit.submit();
			}
			...
			function fn_addFile() {
				var str = "<p>" + "<input type='file' id='file_" + (gfv_count)
						...
						+ (gfv_count) + "' name='delete_" + (gfv_count)
						+ "'>삭제</a>" + "</p>";
				$("#fileDiv").append(str);
