	...
	<div id="wrap" align="center">
		...
		<form id="frm" name="frm" enctype="multipart/form-data">
			...
			<br /> <br /> <a href="#this" class="btn" id="addFile">파일 추가</a> <a
				...
				class="btn" id="write">작성하기</a>
				
				
				
				<input type="hidden" name="CREA_ID" id="CREA_ID"  value="${sessionScope.userId}" readonly="readonly"/>
				<input type="hidden" name="BOARD_CODE" id="BOARD_CODE"  value="1" readonly="readonly"/>
				<input type="hidden" name="BOARD_NAME" id="BOARD_NAME"  value="/sample/freeboardWrite" readonly="readonly"/>
		</form>
